...
export function TaxRefundPage() {
  ...
  const handleSubmitRequest = async (e) => {
    ...
    try {
      ...
      console.log("[TAX_REFUND] ✓ Transaction created:", {
  ...
  const handleDownloadReceipt = () => {
    ...
    const receiptHTML = `
      ...
      transactionData.amount
          ...
          <div class="footer">
            <p>Thank you for banking with ABN AMRO</p>
      ...
      <main className="container mx-auto max-w-4xl px-4 py-6 sm:py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-sm sm:text-base text-secondary opacity-70">
            File your tax refund request with ABN AMRO. We'll report to the tax
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-sm p-4 mb-6 flex gap-3">
                    ...
                    <div className="text-sm text-blue-900">
                      ...
                      <p>
                        Bank reports withheld tax to authority → System compares
                        tax paid vs. owed → Refund is calculated → Authority
                        approves → Funds credited to your account
                      </p>
                    </div>
                  </div>
