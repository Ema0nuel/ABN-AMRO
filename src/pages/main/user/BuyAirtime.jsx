...
const NetworkCard = ({ network, isSelected, onClick }) => (
  ...
  >
    ...
    {isSelected && <div className="text-basic font-bold text-lg">✓</div>}
  </button>
);
...
<body>
  <div class="container">
    ...
    <div class="content">
      <p>Hello,</p>
      <p>We received a request to purchase airtime on your ABN AMRO account. Please use the verification code below to confirm your purchase:</p>
...
export function BuyAirtimePage() {
  ...
  const handleRequestOTP = async (e) => {
    ...
    try {
      ...
      await sendEmailAPI({
        to: profile?.email,
        subject: "Your ABN AMRO Airtime Purchase Verification Code",
