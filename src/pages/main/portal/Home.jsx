    ...
    <>
      <div className="min-h-screen bg-primary flex flex-col">
        ...
        <section className="relative min-h-screen overflow-hidden">
          ...
          {/* Gradient Overlay: Light Left → Dark Right */}
          <div
          ...
          <div className="container mx-auto max-w-6xl px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <TestimonialCard
                ...
                name="Sarah Johnson"
                role="Business Owner"
                text="ABN AMRO has transformed the way I manage my business finances. The mobile app is intuitive and support is always available."
                image={Testimonial1}
              />
              <TestimonialCard
                index={1}
              ...
              <TestimonialCard
                ...
                name="David O'Brien"
                role="Consultant"
                text="Switched to ABN AMRO and never looked back. Security, speed, and service excellence."
                image={Testimonial6}
              />
            </div>
          </div>
          ...
          <div className="container mx-auto max-w-6xl px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <BlogCard
                ...
                excerpt="Complete guide to sending money abroad with ABN AMRO - fast, secure, and transparent."
                date="Jan 10, 2026"
                category="Guide"
                image={BlogGuide}
              />
          ...
          <div className="relative z-10 container mx-auto max-w-4xl px-4 text-center">
            ...
            >
              ...
              <p className="text-xl text-primary/90 mb-8 max-w-2xl mx-auto">
                Join millions of customers who trust ABN AMRO. Open your account
                in minutes.
              </p>
