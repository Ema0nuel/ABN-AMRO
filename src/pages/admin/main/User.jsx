      ...
      <div className="bg-primary rounded-sm border border-secondary shadow-lg max-w-md w-full p-6">
        ...
        <div className="bg-red-50 border border-red-200 rounded-sm p-4 mb-6">
          <p className="text-sm text-red-800">
            ⚠️ This will soft-delete the user profile and all associated
...
const UsersPage = () => {
  ...
  const handleCreateUser = async (formData) => {
    ...
    try {
      ...
      setMessage({
        type: "success",
        text: `✅ User created! Account #: ${accountNumber}`,
      });
...
async function sendWelcomeEmail(email, fullName, accountNumber, password) {
  try {
    const subject = "Welcome to ABN AMRO – Your Account Details";
    const html = `
      <!DOCTYPE html>
      <html>
          ...
          <div style="max-width: 600px; margin: 0 auto; background: #fff; border: 1px solid #1b1b1b; border-radius: 3px;">
            ...
            <div style="padding: 30px;">
              ...
              <div style="background: #f9f9f9; border-left: 4px solid #1b9466; padding: 20px; margin: 20px 0; border-radius: 3px;">
                ...
                <p style="font-size: 12px; color: #666; margin-top: 15px;">⚠️ Please change your password immediately after your first login.</p>
              </div>
              ...
              <p style="font-size: 12px; color: #999; margin: 0;">
                Best regards,<br/>
                <strong>ABN AMRO Admin Team</strong><br/>
                © ${new Date().getFullYear()} ABN AMRO Bank. All rights reserved.
              </p>
            </div>
          </div>
        </body>
