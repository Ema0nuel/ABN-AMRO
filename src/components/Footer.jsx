...
import LOGO from "../assets/images/Logo-abn.svg";
      ...
      <div className="container mx-auto max-w-6xl px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="flex flex-col gap-4">
            <img src={LOGO} alt="ABN AMRO" className="w-32 h-8" />
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start gap-2">
                ...
                <a
                  href="mailto:support@amroabn.cc"
                  className="text-sm opacity-80 hover:text-basic hover:opacity-100 transition-all"
                >
                  support@amroabn.cc
                </a>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-xs opacity-60">
            © {currentYear} ABN AMRO Bank NV. All rights reserved.
          </p>
